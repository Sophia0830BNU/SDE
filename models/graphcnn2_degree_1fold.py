...
class GraphCNN(nn.Module):
    ...
    def CtoD(self, h, node_entropy):
        ...
        h_discrete[top_nodes_indices] = F.gumbel_softmax(F.softmax(h[top_nodes_indices], dim=1), dim=1, tau=0.67)
        #h_discrete[top_nodes_indices] = F.gumbel_softmax(h[top_nodes_indices], dim=1, tau=0.67)
    ...
    def forward(self, batch_graph):
        ...
        return score_over_layer, hidden_rep[-1]
