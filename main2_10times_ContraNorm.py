...
from models.graphcnn2_constra import GraphCNN
...
def main():
    ...
    for seed in range(10):
        ...
        for fold_idx in range(10):
            ...
            model = GraphCNN(args.num_layers, args.num_mlp_layers, args.num_views, train_graphs[0].node_features.shape[1], args.hidden_dim, num_classes, args.final_dropout, args.learn_eps, args.graph_pooling_type, args.neighbor_pooling_type, device).to(device)
